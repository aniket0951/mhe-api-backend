...
class CipherRequestMiddleware(object):
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        if MiddlewareUtils.authenticate_encryption(request) and ENCRYPTION_ENABLED=="True":
...
class CipherResponseMiddleware(object):
    ...
    def process_template_response(self, request, response):
        ...
        if MiddlewareUtils.is_encryption_required(request,response) and ENCRYPTION_ENABLED=="True":
            try:
