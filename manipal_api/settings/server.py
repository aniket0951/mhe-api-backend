...
APNS_USE_SANDBOX = True if env("APNS_USE_SANDBOX") and str(
    env("APNS_USE_SANDBOX")) == "True" else False
...
FEEDBACK_NOTIFICATION_EMAIL_SUBJECT = env(
    "FEEDBACK_NOTIFICATION_EMAIL_SUBJECT")
...
ENCRYPTION_ENABLED = True if env("ENCRYPTION_ENABLED") and str(
    env("ENCRYPTION_ENABLED")) == "True" else False
...
STRICTLY_ENCRYPTED = env("STRICTLY_ENCRYPTED").split(
    ",") if env("STRICTLY_ENCRYPTED") else []
...
FLYER_ENABLED = True if env("FLYER_ENABLED") and str(
    env("FLYER_ENABLED")) == "True" else False
