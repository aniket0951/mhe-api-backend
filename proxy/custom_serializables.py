...
class PatientAppStatus:
    def __init__(self, param):
        ...
        self.android_download = param.get("android_download", "0")
        self.ios_download = param.get("ios_download", "0")
        self.linked_user_count = param.get("linked_user_count", "0")
        self.family_member_count = param.get("family_member_count", "0")
        self.primary_user_count = param.get("primary_user_count", "0")
        self.hv_count = param.get("hv_count", 0)
        self.vc_count = param.get("vc_count", 0)
        self.hc_count = param.get("hc_count", 0)
        self.hv_amount = param.get("hv_amount", 0)
        self.vc_amount = param.get("vc_amount", 0)
        self.ip_deposit_amount = param.get("ip_deposit_amount", 0)
        self.ip_deposit_count = param.get("ip_deposit_count", 0)
        self.hc_package_amount = param.get("hc_package_amount", 0)
        self.op_outstanding_amount = param.get("op_outstanding_amount", 0)
        self.registered_patient_count = param.get("registered_patient_count", 0)
        self.registration_amount = param.get("registration_amount", 0)
        self.home_collection_count = param.get("home_collection_count", 0)
        self.home_service_count = param.get("home_service_count", 0)
        self.preferred_hospital_count = param.get("preferred_hospital_count", 0)
