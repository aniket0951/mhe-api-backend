...
class PatientAppStatus:
    def __init__(self, param):
        ...
        self.android_download = param.get("android_download", None)
        self.ios_download = param.get("ios_download", None)
        self.linked_user_count = param.get("linked_user_count", None)
        self.family_member_count = param.get("family_member_count", None)
        self.primary_user_count = param.get("primary_user_count", None)
        self.hv_count = param.get("hv_count", None)
        self.vc_count = param.get("vc_count", None)
        self.hc_count = param.get("hc_count", None)
        self.hv_amount = param.get("hv_amount", None)
        self.vc_amount = param.get("vc_amount", None)
        self.ip_deposit_amount = param.get("ip_deposit_amount", None)
        self.ip_deposit_count = param.get("ip_deposit_count", None)
        self.hc_package_amount = param.get("hc_package_amount", None)
        self.op_outstanding_amount = param.get("op_outstanding_amount", None)
        self.registered_patient_count = param.get("registered_patient_count", None)
        self.registration_amount = param.get("registration_amount", None)
        self.home_collection_count = param.get("home_collection_count", None)
        self.home_service_count = param.get("home_service_count", None)
        self.preferred_hospital_count = param.get("preferred_hospital_count", None)
