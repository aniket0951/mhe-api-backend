...
class DrivePaymentStatus:
    
    def __init__(self, param):
        self.location_code = param.get("location_code", None)
        self.uhid = param.get("uhid")
        self.email_id = param.get("email_id")
        self.mobile_no = param.get("mobile_no")
        self.transaction_id = param.get("transaction_id")
        self.payment_status = param.get("payment_status")
        self.payment_date = param.get("payment_date")
        self.order_id = param.get("order_id")
        self.aadhar_number = param.get("aadhar_number")
        self.cowin_number = param.get("cowin_number")
        self.vaccination_date = param.get("vaccination_date")
        self.vaccination_dose = param.get("vaccination_dose")
        self.vaccination_name = param.get("vaccination_name")
        self.apartment_name = param.get("apartment_name")
        self.vaccination_item_code = param.get("vaccination_item_code")
        self.vaccination_charges = param.get("vaccination_charges")
        self.medical_service_charges = param.get("medical_service_charges")
        self.total_paid_amt = param.get("total_paid_amt")
        self.post_flag = param.get("post_flag")
        self.resource = param.get("resource")
        self.name = param.get("name")
        
    def serialize(self, serializer):
        serializer.start_object('VacRegparam')
        serializer.add_property('HospCode', self.location_code)
        serializer.add_property('UHID', self.uhid)
        ...
        serializer.add_property('cowin_number', self.cowin_number)
        serializer.add_property('vaccination_date', self.vaccination_date)
        serializer.add_property('vaccination_dose', self.vaccination_dose)
        serializer.add_property('vaccination_name', self.vaccination_name)
        serializer.add_property('apartment_name', self.apartment_name)
        serializer.add_property('vaccination_item_code', self.vaccination_item_code)
        serializer.add_property('vaccination_charges', self.vaccination_charges)
        serializer.add_property('Medical_ServiceCharges', self.medical_service_charges)
        serializer.add_property('totalPaidAmt', self.total_paid_amt)
        serializer.add_property('post_flag', self.post_flag)
        serializer.add_property('resource', self.resource)
